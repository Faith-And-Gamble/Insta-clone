            ...
            <div className="profile__section">
                <div className="container">
                    ...
                    <div className="profile__section__tab">
                        <button className="tablinks" onClick="openSection(event, 'Posts')" id="defaultOpen">
                            ...
                            Posts</button>
                        <button className="tablinks" onClick="openSection(event, 'Videos')">
                            ...
                            Videos</button>
                        <button className="tablinks" onClick="openSection(event, 'Saved')">
                            <svg aria-label="" className="_ab6-" color="#8e8e8e" fill="#8e8e8e" height="12" role="img" viewBox="0 0 24 24" width="12">
                                <polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polygon>
                            </svg>
                            Saved</button>
                        <button className="tablinks" onClick="openSection(event, 'Tagged')">
                            <svg aria-label="" className="_ab6-" color="#8e8e8e" fill="#8e8e8e" height="12" role="img" viewBox="0 0 24 24" width="12">
